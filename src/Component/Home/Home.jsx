...
<div className='mt-[18rem]  absolute ml-[20rem] font-bold   '>TEXT!</div>
...
<main className=" flex justify-center ">
   <img className='w-full h-[30rem]   ' src="https://th.bing.com/th/id/OIP.tMqMvkqSSsQO0yuDXhJ4PQAAAA?rs=1&pid=ImgDetMain" alt="" />
      <div className=' absolute flex   justify-center py-10 mb-10 mt-20 border-black bg-black bg-opacity-30 w-[48rem] h-[20rem] font-medium border-2 rounded-lg hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] sm:w-[35rem] pn:w-[30rem]  pn:mr-4'>
    <form className=' '  action="">
      ...
      <button className=' bg-sky-600 px-9  mt-[5rem] ml-[15rem] text-white font-bold hover:font-extrabold  flex py-1 rounded-md '>Go<img className='pl-2 pt-1' src={arrowforward} alt="" /> </button>
