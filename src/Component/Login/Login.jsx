  ...
  return (
    ...
    <form className='absolute bottom-[12rem]  2xl:ml-[60rem] md:ml-[10rem] sm:ml-[7rem] sm:w-[26rem] pn:ml-3 pn:w-[28rem] bg-blue-300 bg-opacity-80 flex justify-center direction-column w-[30rem] mx-[30rem] mt-[6rem] py-[2rem] text-center rounded-2xl text-black ' >
      <div >
        ...
        <button className="font-semibold mt-4 bg-blue-500 w-[4rem] h-[2rem] rounded-md" onClick={handleLogin} >Login</button>
        <div className="font-semibold mt-2">Don't have an account? <button className='text-blue-800 font-semibold text-lg underline underline-offset-1' onClick={gotoSignupPage}>Sign up</button></div>
...
<div className='flex justify-center items-center ' >
       <button className='bg-white pl-2 flex rounded-md bg-opacity-90 font-semibold w-[11rem] h-[2rem] ' onClick={() => login()}>Login with Google 
